...
namespace Afisha.Graphql.Infrastructure.DataLoader.GreenDonutDataLoader
{
    public static class DataLoaderResolverContextExtensions
    {
            ...
            where T : class, IDataLoader
        {
            ...
            (
                ...
                r => r.Register(key, services =>
                {
                    ...
                    return instance ?? ActivatorHelper.CompileFactory<T>().Invoke(services);
                })
            );
        }
            ...
            where T : IDataLoader
        {
            if (registry == null)
            {
                throw new InvalidOperationException("TypeResources.DataLoaderResolverContextExtensions_RegistryIsNull");
            }
            ...
            if (!registry.TryGet(key, out T dataLoader))
            {
                ...
                {
                    throw new InvalidOperationException("TypeResources.DataLoaderResolverContextExtensions_UnableToRegister");
                }
            }
