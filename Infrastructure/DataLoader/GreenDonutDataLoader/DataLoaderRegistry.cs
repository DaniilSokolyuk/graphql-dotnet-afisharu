...
namespace Afisha.Graphql.Infrastructure.DataLoader.GreenDonutDataLoader
{
        ...
        , IDisposable
    {
        ...
        private readonly ConcurrentDictionary<string, Func<IDataLoader>> _factories = new ConcurrentDictionary<string, Func<IDataLoader>>();
        private readonly ConcurrentDictionary<string, IDataLoader> _instances = new ConcurrentDictionary<string, IDataLoader>();
        private ImmutableHashSet<IObserver<IDataLoader>> _observers = ImmutableHashSet<IObserver<IDataLoader>>.Empty;
