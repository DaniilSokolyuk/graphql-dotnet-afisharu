...
{
    public class GraphMiddleWare<TSchema> where TSchema : ISchema
    {
        ...
        private readonly ILogger<GraphMiddleWare<TSchema>> _logger;
        private readonly RequestDelegate _next;

        public GraphMiddleWare(
            RequestDelegate next, 
            ILogger<GraphMiddleWare<TSchema>> logger)
        {
            _next = next;
            _logger = logger;
        }
